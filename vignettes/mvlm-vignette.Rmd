...
This package allows users to conduct MMR and MANOVA in conjunction with the the analytic p-values proposed by McArtor, Lubke, & Bergeman (under review), in lieu of classical $p$-values based on statistics such as Wilks' Lambda and Pillai's Trace.
